 ...
 */
import { z } from 'zod';
export declare const PersistedEndReason: z.ZodEnum<["completed", "candidate_terminated", "timeout", "technical_failure", "timer", "cap", "end_button", "verbal", "end_flag", "cap_reached", "time_up", "verbal_end", "tampering"]>;
export type PersistedEndReason = z.infer<typeof PersistedEndReason>;
/** Smaller subset emitted on the WS `interview_ended.reason` frame. */
export declare const WsInterviewEndedReason: z.ZodEnum<["completed", "candidate_terminated", "timeout", "technical_failure", "time_up", "cap_reached", "end_button", "verbal_end"]>;
export type WsInterviewEndedReason = z.infer<typeof WsInterviewEndedReason>;
