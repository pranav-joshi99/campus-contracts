...
export const WELCOME_TEXT_TEMPLATE =
  'Hello {CANDIDATE_NAME}, How are you feeling today? Welcome to the interview section of this assessment. Please begin by introducing yourself in a brief manner.'
export const BRANCH_A_TEXT =
  "Let's begin by assessing your speaking and communication skills before we get on with the technical interview."
export const BRANCH_B_TEXT = 'Thank you for your introduction.'
export function renderWelcomeText(candidateName: string): string {
